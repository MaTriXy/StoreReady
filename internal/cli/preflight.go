...
var preflightCmd = &cobra.Command{
	Use:     "preflight [path]",
	Aliases: []string{"appstore-checkup", "apple-appstore-checkup"},
	Short:   "Run ALL checks on your project — one command, zero uploads",
	Long: `Run every storeready check in a single command. No App Store Connect
...
Usage:
  storeready preflight .
  storeready preflight ./my-app --ipa build.ipa
  storeready preflight /path/to/project --format json`,
...
func runPreflight(cmd *cobra.Command, args []string) error {
	...
	// Banner
	purple.Println("\n  storeready preflight — every check, one command, zero uploads.")
